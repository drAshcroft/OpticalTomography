...
namespace ImageViewer.Convolution
{
    public class ConvolutionFilterImplented
    {
        ...
        public static Bitmap ConvolutionFilter(Bitmap SourceImage, IConvolutionKernal Kernal)
        {
            ...
            double[,] bInData = ImagingTools.ConvertToDoubleArray(SourceImage, false);
            ...
            return ImagingTools.ConvertToBitmap(bOutData);
        }
        ...
        public static ImageHolder ConvolutionFilter(ImageHolder SourceImage, IConvolutionKernal Kernal)
        {
            ...
            return ImagingTools.ConvertToGrayScaleImage(bOutData, 1);
        }
        ...
        /// <returns></returns>
        public static double[,] ConvolutionFilter(double[,] SourceImage, ImageViewer.Convolution.IConvolutionKernal Kernal)
        {
