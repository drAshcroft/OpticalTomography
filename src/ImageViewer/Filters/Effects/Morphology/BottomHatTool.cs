...
{
    public class BottomHatTool:ErosionTool 
    {
        public override string EffectName
        {
            get
            {
                return "Bottom Hat Filter";
            }
        }

        public override System.Drawing.Bitmap RunEffectImpl(System.Drawing.Bitmap SourceImage, short[,] StructureElement)
        {
            BottomHat   Filter = new AForge.Imaging.Filters.BottomHat  (StructureElement);
        ...
        /// <returns></returns>
        public static ImageHolder BottomHat(ImageHolder SourceImage, int Size)
        {
        ...
        /// <param name="Size">Must be odd and larger than 3</param>
        /// <returns></returns>
        public static Bitmap BottomHat(Bitmap SourceImage, int Size)
        {
            short[,] StructureElement = StructuringElement.CreateSECircle((byte)Size);
            BottomHat Filter = new AForge.Imaging.Filters.BottomHat(StructureElement);
            Bitmap holding = Filter.Apply(SourceImage);
