...
{
    public partial class MedianFilter1DYTool : aEffectForm
    {
        public MedianFilter1DYTool()
            : base()
        {
            SetParameters(new string[] { "Radius" }, new int[] { 3 }, new int[] { 25 });

        }
        public override string EffectName { get { return "Median Filter 1D Y"; } }
        ...
        protected override object doEffect(DataEnvironment dataEnvironment, object SourceImage, ReplaceStringDictionary PassData, params object[] Parameters)
        {
            ...
            MedianKernal vak = new MedianKernal(new int[]{1,(int)mFilterToken[0]});
