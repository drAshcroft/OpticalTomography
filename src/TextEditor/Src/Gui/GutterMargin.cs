...
namespace ICSharpCode.TextEditor
{
	...
	public class GutterMargin : AbstractMargin, IDisposable
	{
		...
		static GutterMargin()
		{
			Stream cursorStream = Assembly.GetCallingAssembly().GetManifestResourceStream("IronPythonEditor.Resources.RightArrow.cur");
            if (cursorStream == null)
                cursorStream = Assembly.GetCallingAssembly().GetManifestResourceStream("IronPythonEditor.Resources.RightArrow.cur");
