...
namespace DoRecons
{
    public class BaseScriptSingle : IScript
    {
        ...
        protected void FindFirstCell()
        {
            ...
            //else
            {
                ...
                if (CellWanderArea.X < 100 || CellWanderArea.Width > 700)
                {
        ...
        {
            if (BlobsFound == true || CellAreadyFound == false)
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < X_Positions.Length; i++)
                    {
                        X_PositionsB[i] = X_Positions[i];
                        Y_PositionsB[i] = Y_Positions[i];
                    }
                }
        ...
        protected virtual void PreBatchProcessCenter()
        {
            ...
            FineCellSize = (int)(tCellSize * 2.1) + 20;
            FineCellHalf = FineCellSize / 2;

            ReconCellSize = (int)(.9 * FineCellSize);// (int)(tCellSize * 1.3) + 20;
