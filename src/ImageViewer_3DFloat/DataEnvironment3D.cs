...
namespace ImageViewer3D
{
    ...
    public class DataEnvironment3D
    {
        ...
        public void AutoSetContrast()
        {
            ...
            unsafe
            {
                fixed (float* pData = OriginalData.Data)
                {
                    float* pIn = pData;
            ...
            /*   MaxContrast = MaxPossibleContrast;
               MinContrast = Average;*/
            double bright = .4;
            double Contrast = .3;
            MinContrast = MinPossibleContrast + ( MaxPossibleContrast - MinPossibleContrast )*(bright - Contrast ) ;
            MaxContrast = MinPossibleContrast + (MaxPossibleContrast - MinPossibleContrast) * (bright + Contrast ) ;
        ...
        public Bitmap GetSlice(int Axis, int SliceNumber)
        {
            ...
            return OriginalData.GetSlice(Axis, SliceNumber, mMinContrast, mMaxContrast);
        }
