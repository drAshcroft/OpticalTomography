...
{
    public partial class vArrowSlider : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.FillRectangle(new SolidBrush(mSliderColor), new Rectangle(0, (int)((Value - Minimum) / (Maximum-Minimum ) * (double)(mMaxPixel - mMinPixel) + mMinPixel ) - 2, this.Width, 5));
        }
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            {
                mCurrentValue = (Maximum - Minimum) * (double)e.Y / (double)(mMaxPixel - mMinPixel) + Minimum;
