    ...
    public class MIPTool : aEffectForm3D
    {
        ...
        void button2_Click(object sender, EventArgs e)
        {
            ...
            if (ret == DialogResult.OK)
            {
                ...
                float[,] ProjectionOut = new float[mSourceImage.Width, mSourceImage.Height];
                for (int i = 0; i < 360; i++)
                {
                    currentIndex = i;
                    DoMIPProjection_OneSlice(ref ProjectionOut, (double)i / 180d * Math.PI);
                    Bitmap bmp = MathImageHelps.MakeBitmap(ProjectionOut); 
        ...
        void timer_Tick(object sender, EventArgs e)
        {
            ...
            Bitmap holding = MathImageHelps.MakeBitmap(Projection);//,MinContrast,MaxContrast );
        ...
        public void DoMIPProjection_OneSlice(ref float[,] SliceProjection, double AngleRadians)
        {
        ...
        public float[,] ProjectMIP(float[, ,] mDataDouble, Point3D Direction, Point3D FastScanDirection)
        {
