...
namespace ImageViewer3D.Filters.Analysis
{
    public partial class ProfileTool : aEffectForm3D
    {
        ...
        private System.Windows.Forms.Button bCopyData;
        ...
        private void pInitializeComponent()
        {
            ...
            this.bCopyData = new System.Windows.Forms.Button();
            ...
            // CopyData
            // 
            this.bCopyData.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right)));
            this.bCopyData.Location = new System.Drawing.Point(673-bFinished.Width -10, 430);
            this.bCopyData.Name = "Copy Data";
            this.bCopyData.Size = new System.Drawing.Size(67, 35);
            this.bCopyData.TabIndex = 25;
            this.bCopyData.Text = "Copy Data";
            this.bCopyData.UseVisualStyleBackColor = true;
            this.bCopyData.Click += new EventHandler(bCopyData_Click);
            ...
            this.Controls.Add(this.bCopyData);
            this.bCopyData.Visible = true;
        ...
        protected override ImageViewer3D.DataHolder doEffect(ImageViewer3D.DataEnvironment3D dataEnvironment, ImageViewer3D.DataHolder SourceImage, ImageViewer.Filters.ReplaceStringDictionary PassData, params object[] Parameters)
        {
            ...
            mDataEnvironment.ViewerControl.ActiveDrawingTool = new ImageViewer3D.Tools.ProfileTool3D();
        ...
        void mDataEnvironment_SelectionPerformed(DataEnvironment3D SourceImage, ISelection3D SelectionIn)
        {
            try
            {
                if (SelectionIn != null)
                {
                    ISelection3D Selection = (ISelection3D)SelectionIn;
                    ImageViewer3D.Selections.ProfileSelection3D ps = (ImageViewer3D.Selections.ProfileSelection3D)Selection;

                    Profile = SourceImage.OriginalData.GetProfile(ps.SelectionAxis, ps.SelectionSliceNumber, ps.P2, ps.P1);
        ...
        void bCopyData_Click(object sender, EventArgs e)
        {
            if (Profile != null)
            {
                string Junk = "Intensity\n";

                for (int i = 0; i < Profile.Length; i++)
                {
                    Junk += Profile[i].ToString() + "\n";
                }
