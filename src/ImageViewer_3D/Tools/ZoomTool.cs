...
namespace ImageViewer3D.Tools
{
    public class ZoomTool : ROITool
    {
        ...
        protected override void MouseUpImpl(Point MovePoint, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            {
                mScreenProperties.VirtualPictureBox = new Rectangle(0, 0, mScreenProperties.ViewPictureSize.Width, mScreenProperties.ViewPictureSize.Height);
            }
        ...
        private void HandleSelectionDone(Rectangle SelectionBox)
        {
            ...
            {
                double aspect = (double)mScreenProperties.ViewPictureSize.Width / (double)mScreenProperties.ViewPictureSize.Height;
            ...
            mScreenProperties.SetGlobalZoom(mZoomBox , MagX,MagY );
            mScreenProperties.SetSliderBounds(mZoomBox);

            double left = mZoomBox.X * MagX;
            double top = mZoomBox.Y * MagY;

            mScreenProperties.VirtualPictureBox.Width = (int)(mScreenProperties.ViewPictureSize.Width * MagX);
            mScreenProperties.VirtualPictureBox.Height = (int)(mScreenProperties.ViewPictureSize.Height * MagY);
