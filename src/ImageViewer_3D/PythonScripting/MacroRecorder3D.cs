...
namespace ImageViewer3D.PythonScripting
{
    public partial class MacroRecorder3D : Form,IEffect3D 
    {
        ...
        private IronPythonEditor.TextEditor.TextEditorForm textEditorForm1;
        private IronPythonEditor.Console.IronPythonConsole ironPythonConsole1;
        private IronPythonEditor.VariableWindow.VariableWindow variableWindow1;
        ...
        private void InitializeComponent()
        {
            ...
            // 
            this.splitContainer1.Panel1.Controls.Add(this.textEditorForm1);
            // 
            ...
            this.textEditorForm1.Location = new System.Drawing.Point(0, 0);
            this.textEditorForm1.Name = "textEditorForm1";
            this.textEditorForm1.Size = new System.Drawing.Size(723, 321);
            ...
            this.variableWindow1.Size = new System.Drawing.Size(204, 321);
            this.variableWindow1.TabIndex = 2;
            // 
            // ironPythonConsole1
            // 
            this.ironPythonConsole1.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)
                        | System.Windows.Forms.AnchorStyles.Right)));
            ...
            this.ironPythonConsole1.Location = new System.Drawing.Point(0, 328);
            this.ironPythonConsole1.Name = "ironPythonConsole1";
            this.ironPythonConsole1.Size = new System.Drawing.Size(931, 162);
            this.ironPythonConsole1.TabIndex = 1;
            ...
            this.Controls.Add(this.ironPythonConsole1);
...
"Please choose a directory and filename for the output.  Files will be outputed with an added index, i.e.  If you give c:\\test.bmp, the program will output c;\\test0.bmp, c:\\test1.bmp ...");
            ...
            if (ret == DialogResult.OK)
            {
                ...
                string[] Sorted = ImagingTools.SortNumberedFiles(filenames);
                ...
                if (ret == DialogResult.OK)
                {
                   ...
                   // if (PythonScripting.Arrays.CreateGlobalArrayTool.ScriptGlobalArrays != null)
                    ...
                    Variables.Add("LibraryPath", Path.GetDirectoryName(Application.ExecutablePath ) + "\\ImageViewer3D.dll");
...
clr.AddReferenceToFileAndPath(ExecutablePath + 'ImageViewer3D.dll')
