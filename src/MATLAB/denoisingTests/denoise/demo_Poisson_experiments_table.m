...
load ./denoise/images/images.mat   % Load the five images used for the experiments reported in [3] and [1,2]. These images are kindly provided by the authors of [3].
