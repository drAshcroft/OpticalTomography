...
demo_TUT_ComSensImRec.m       main script
...
function_BM3D_HT_double.m     function wrapper for BM3D
...
Requirements
------------
This demo is designed for Matlab for Windows 32-bit (ver. 7.4 and above)
