...
namespace MathHelpLib
{
    public  class Filtering
    {
        ...
        /// <param name="Impulse"></param>
        /// <returns></returns>
        public static double[,] ConvoluteChopSeperable(double[,] Array1, double[] Impulse)
        {
            double[,] A1 = ConvoluteChop1D(Axis.XAxis, Array1, Impulse);
            return ConvoluteChop1D(Axis.YAxis, A1, Impulse);
        }
