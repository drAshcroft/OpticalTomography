...
namespace MathHelpLib
{
    ...
    public static class MathComplexHelps
    {
        ...
        /// <param name="Impulse"></param>
        /// <returns></returns>
        public static complex[,] ConvoluteChop1D(Axis DesiredAxis, complex[,] Array1, double[] Impulse)
        {
            if (DesiredAxis == Axis.XAxis)
                return ConvoluteChopXAxis(Array1, Impulse);
            else
                return ConvoluteChopYAxis(Array1, Impulse);
        }
